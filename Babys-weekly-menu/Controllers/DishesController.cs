...
namespace BabysWeeklyMenu.Controllers
{
    public class DishesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Image")] Dish dish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Image")] Dish dish)
        {
            if (id != dish.Id)
            {
                return NotFound();
